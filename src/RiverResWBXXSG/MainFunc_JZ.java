...
public class MainFunc_JZ {
	...
	public static void main(String[] args) {
		 ...
		 */
		String OutputName = "test9 100 1000 1968 ys.xls.xls";// ------------------------------------------------------定义输出名
		int time = 601;// -----------------------------------------------------------------------优化次数
		// -----水库群计算顺序获取---------------
		getResINFO dddd = new getResINFO();
		String filepath1 = "RiverData/JSJ/JZ/ResStr.xls";
		...
		// -----水库群水位控制曲线----------
		String filepath2 = "RiverData/JSJ/JZ/ResColLev.xls";
		dddd.getResControlLevs(filepath2, calbean);
		System.out.println("2");
		// -----水库群泄流控制过程----------
		String filepath21 = "RiverData/JSJ/JZ/ResColflow.xls";
		System.out.println("3");
		dddd.getResControlQouts(filepath21, calbean);
		// ---------------------------
		// -----水库群基础信息获取----------
		String filepath3 = "RiverData/JSJ/JZ/";
