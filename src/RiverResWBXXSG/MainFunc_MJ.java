...
public class MainFunc_MJ {
	...
	public static void main(String[] args) {
		...
		String filepath1 = "RiverData/MJ/ResStr.xls";
		...
		// -----水库群水位控制曲线----------
		String filepath2 = "RiverData/MJ/ResColLev.xls";
		dddd.getResControlLevs(filepath2, calbean);
		System.out.println("2");
		// -----水库群泄流控制过程----------
		String filepath21 = "RiverData/MJ/ResColflow.xls";
		System.out.println("3");
		dddd.getResControlQouts(filepath21, calbean);
		// ---------------------------
		// -----水库群基础信息获取----------
		String filepath3 = "RiverData/MJ/";
