...
public class MainFunc_WJ {
	...
	public static void main(String[] args) {
		...
		String filepath1 = "RiverData/WJ/ResStr.xls";
		...
		// -----水库群水位控制曲线----------
		String filepath2 = "RiverData/WJ/ResColLev.xls";
		dddd.getResControlLevs(filepath2, calbean);
		System.out.println("2");
		// -----水库群泄流控制过程----------
		String filepath21 = "RiverData/WJ/ResColflow.xls";
		System.out.println("3");
		dddd.getResControlQouts(filepath21, calbean);
		// ---------------------------
		// -----水库群基础信息获取----------
		String filepath3 = "RiverData/WJ/";
